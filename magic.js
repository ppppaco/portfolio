...
function init () {
	...
	if (is_index) {
		if (view == "grid") {
			...
			$("#view_options").html("<li><a href=\"#list\" id=\"show_list_link\" class=\"rounded\">timeline</a></li>")	
			...
			$("#view_options").html("<li><a href=\"#grid\" class=\"rounded\" id=\"show_grid_link\">grid</a></li>")
